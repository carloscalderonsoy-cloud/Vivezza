      ...
      <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          <div className="inline-flex items-center gap-2 self-start rounded-full border px-3.5 py-1.5 text-[11px] font-bold tracking-[0.12em] uppercase"
            ...
            Especialidad certificada · Vivezza
          </div>

          <h1 className="text-[clamp(2.4rem,5.5vw,4.8rem)] font-extrabold leading-[1.02] tracking-[-0.03em] text-ink">
            Cirugía Plástica<br />
            <span style={{ color: ACCENT }}>con respaldo</span><br />
            hospitalario completo.
          </h1>

          <p className="text-[16px] leading-[1.65] text-muted max-w-[54ch]">
            Procedimientos estéticos y reconstructivos realizados en quirófano certificado, con anestesiología exclusiva y seguimiento post-operatorio 24/7 — no una clínica ambulatoria.
          </p>

          {/* Certifications */}
          <div className="flex flex-wrap gap-2.5">
            {['Cirugía Plástica y Reconstructiva', 'CONACEM Certificada', 'JCI Acreditado', 'Anestesiología dedicada'].map((c) => (
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <a href="#form"
              ...
              Solicitar pre-consulta gratuita
        ...
        <div className="lg:col-span-5">
          <div className="relative">
            <div className="relative overflow-hidden rounded-[32px] aspect-[4/5] bg-stone">
              <Image src="/photos/plastic-surgery.png" alt="Dra. Isabel Montero — Cirujana Plástica"
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                ...
                <div className="text-[11.5px] font-semibold uppercase tracking-[0.14em] mt-1.5 opacity-90">
                  Cirujana Plástica — Jefa de especialidad
                </div>
                <div className="flex items-center gap-1 mt-3">
                  {[1,2,3,4,5].map(i => <svg key={i} width="12" height="12" viewBox="0 0 24 24" fill={ACCENT}><path d="m12 2 3 7h7l-5.5 4.5L18 21l-6-4-6 4 1.5-7.5L2 9h7l3-7Z" /></svg>)}
                  <span className="ml-2 text-[11px] font-semibold opacity-80">4.98 · +380 pacientes</span>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-4 -right-3 sm:-right-8 bg-white border border-ink/8 shadow-xl rounded-2xl px-4 py-3.5">
              <div className="text-[11px] font-bold uppercase tracking-[0.14em] text-muted mb-1">Experiencia</div>
              <div className="text-[1.6rem] font-extrabold text-ink leading-none">12+</div>
              <div className="text-[11px] font-semibold text-muted mt-0.5">años de práctica</div>
            </div>
          </div>
        </div>
      </div>
...
function WhenSection() {
  const situations = [
    { emoji: '🤱', title: 'Después de la maternidad', desc: 'Tu abdomen, busto o figura cambiaron con el embarazo y el ejercicio ya no es suficiente.' },
    { emoji: '⚖️', title: 'Pérdida de peso significativa', desc: 'Bajaste mucho de peso y tienes piel sobrante que te incomoda o limita.' },
    { emoji: '👃', title: 'Tu nariz no armoniza con tu rostro', desc: 'No se trata de moda, sino de sentirte en paz con tu reflejo.' },
    { emoji: '💪', title: 'Quieres definición que no logras en el gym', desc: 'La liposucción HD y el BBL trabajan lo que el entrenamiento no puede.' },
    { emoji: '🪞', title: 'El tiempo está cambiando tu rostro', desc: 'Ptosis, párpados caídos o pérdida de volumen que afectan tu confianza.' },
    { emoji: '💊', title: 'Asimetría o malformación que te afecta', desc: 'Cirugía reconstructiva para corregir diferencias congénitas o post-accidente.' },
  ]
    ...
    <section className="section-pad py-20 bg-stone">
      <div className="max-w-3xl mb-12">
        ...
        <h2 className="text-[clamp(1.9rem,4vw,3.2rem)] font-bold leading-[1.1] tracking-[-0.025em] text-ink mb-4">
          ¿Cuándo es el momento<br /><span className="text-muted font-semibold">de verte con nosotros?</span>
        </h2>
        <p className="text-[15px] leading-[1.65] text-muted max-w-[56ch]">
          No necesitas esperar a "el momento perfecto". Si alguna de estas situaciones te describe, una pre-consulta sin costo puede darte claridad.
        </p>
      </div>
  ...
  const procs = [
    {
      ...
      tag: 'Busto',
      desc: 'Incremento de volumen con implantes de silicón de alta cohesividad o mediante lipotransferencia. Incisiones mínimas, recuperación de 7–10 días.',
    },
    {
      name: 'Reducción mamaria',
      tag: 'Busto',
      desc: 'Alivia el dolor de espalda, mejora la postura y redefine la silueta. Indicada cuando el volumen genera molestias físicas o psicológicas.',
    },
    {
      name: 'Mastopexia (levantamiento)',
      tag: 'Busto',
      desc: 'Reposiciona el busto caído sin necesariamente cambiar volumen. Puede combinarse con aumento para resultados más completos.',
    },
    {
      name: 'Rinoplastia',
      tag: 'Rostro',
      desc: 'Corrección estética y/o funcional de la nariz. Abordaje cerrado o abierto según cada caso. Resultados definitivos a los 6–12 meses.',
    },
    {
      name: 'Abdominoplastia',
      tag: 'Cuerpo',
      desc: 'Extirpación de piel sobrante y reparación muscular del abdomen. Ideal post-maternidad o tras pérdida de peso significativa.',
    },
    {
      name: 'Liposucción Vaser HD',
      tag: 'Cuerpo',
      desc: 'Definición muscular de alta definición mediante ultrasonido. Permite esculpir abdomen, flancos, espalda y muslos con precisión milimétrica.',
    },
    {
      name: 'BBL (Brazilian Butt Lift)',
      tag: 'Cuerpo',
      desc: 'Transferencia de grasa propia para dar proyección y forma a los glúteos. Sin implantes, resultado natural con grasa de tu propio cuerpo.',
    },
    {
      name: 'Mommy Makeover',
      tag: 'Combinado',
      desc: 'Protocolo combinado que puede incluir abdominoplastia, mamoplastia y lipo en una sola cirugía. Recuperación única, resultados integrales.',
    },
    {
      name: 'Lifting facial',
      tag: 'Rostro',
      desc: 'Reposiciona tejidos caídos de mejillas, cuello y mandíbula. Resultado natural que rejuvenece sin cambiar tu identidad.',
    },
    {
      name: 'Blefaroplastia',
      tag: 'Rostro',
      desc: 'Corrección de párpados superiores e inferiores caídos o con exceso de piel. Procedimiento ambulatorio de alta precisión.',
    },
    {
      name: 'Otoplastia',
      tag: 'Rostro',
      desc: 'Reposición de orejas prominentes. Muy frecuente en niños y adultos. Alta satisfacción y recuperación rápida.',
    },
  ]

  const tags = ['Todos', 'Busto', 'Rostro', 'Cuerpo', 'Combinado']
  const [active, setActive] = useState('Todos')
  const filtered = active === 'Todos' ? procs : procs.filter(p => p.tag === active)
  ...
  return (
    <section id="procedimientos" className="section-pad py-20 bg-white">
      <div className="max-w-3xl mb-10">
        ...
        <h2 className="text-[clamp(1.9rem,4vw,3.2rem)] font-bold leading-[1.1] tracking-[-0.025em] text-ink mb-4">
          Lo que realizamos<br /><span className="text-muted font-semibold">en Vivezza Plástica</span>
        </h2>
      </div>
...
function WhySection() {
  const diffs = [
    {
      icon: '🏥',
      title: 'Respaldo hospitalario completo',
      desc: 'No operamos en clínicas ambulatorias. Cada procedimiento se realiza en quirófano certificado con equipo de soporte hospitalario disponible.',
    },
    {
      icon: '💉',
      title: 'Anestesiología exclusiva y certificada',
      desc: 'Contamos con anestesiólogos dedicados a plástica. Monitoreo total durante y después de la cirugía. Sin subcontratos externos.',
    },
    {
      icon: '🛏️',
      title: 'Recuperación supervisada 24/7',
      desc: 'Área de recuperación con enfermería especializada. El equipo médico está disponible las primeras 24 horas post-operatorio.',
    },
    {
      icon: '📋',
      title: 'Seguimiento y documentación de resultados',
      desc: 'Protocolo fotográfico, valoraciones a las 2 semanas, 1 mes, 3 meses y 6 meses. Tus resultados se documentan y optimizan.',
    },
  ]
  ...
  return (
    <section className="section-pad py-20 bg-stone">
      <div className="max-w-3xl mb-12">
        ...
        <h2 className="text-[clamp(1.9rem,4vw,3.2rem)] font-bold leading-[1.1] tracking-[-0.025em] text-ink mb-4">
          ¿Por qué Vivezza<br /><span className="text-muted font-semibold">para tu cirugía plástica?</span>
        </h2>
      </div>
      ...
      <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="bg-white rounded-2xl border border-ink/8 p-5 text-center">
            <div className="text-[2rem] font-extrabold text-ink leading-none mb-1" style={i === 0 || i === 1 ? { color: ACCENT } : {}}>{s.v}</div>
...
function GallerySection() {
  const photos = [
    { src: '/photos/plastic-surgery.png', label: 'Quirófano certificado' },
    { src: '/photos/surgery-team.png', label: 'Equipo especializado' },
    { src: '/photos/recovery-room.png', label: 'Área de recuperación' },
    { src: '/photos/patient-consultation.png', label: 'Consulta inicial' },
  ]
    ...
    <section className="section-pad py-20 bg-white">
      <div className="max-w-3xl mb-10">
        ...
        <h2 className="text-[clamp(1.9rem,4vw,3.2rem)] font-bold leading-[1.1] tracking-[-0.025em] text-ink mb-3">
          Conoce Vivezza Plástica
        </h2>
        <p className="text-[15px] leading-[1.65] text-muted max-w-[52ch]">
          Resultados de antes y después disponibles en consulta privada, respetando la confidencialidad de cada paciente.
        </p>
      </div>

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {photos.map((p, i) => (
          <div key={i} className="relative overflow-hidden rounded-2xl aspect-square bg-stone group">
            <Image src={p.src} alt={p.label} fill className="object-cover transition-transform duration-500 group-hover:scale-105" />
            <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, transparent 50%, rgba(10,16,28,0.6) 100%)' }} />
            <div className="absolute bottom-3 left-3 text-white text-[11px] font-bold uppercase tracking-[0.12em]">{p.label}</div>
          </div>
        ))}
      </div>

      <div className="mt-6 rounded-2xl border border-orange-200 bg-orange-50 p-5 flex items-start gap-4">
        <div className="text-2xl shrink-0">🔒</div>
        <p className="text-[13.5px] leading-[1.6] text-ink/75">
          <strong>Confidencialidad garantizada.</strong> El material fotográfico de antes y después se muestra exclusivamente durante la consulta médica, con autorización firmada de cada paciente. Tu privacidad es parte del protocolo Vivezza.
        </p>
      </div>
    </section>
  )
...
function PreConsultaForm() {
    ...
    return (
      <section id="form" className="section-pad py-20 bg-stone">
        <div className="max-w-xl mx-auto text-center">
          ...
          <h3 className="text-[1.8rem] font-bold text-ink mb-3">¡Tu pre-consulta fue enviada!</h3>
          <p className="text-[15px] text-muted leading-[1.65] mb-6">
            Se abrió WhatsApp con tu información. El equipo de Vivezza te responde en menos de 30 minutos en horario de atención.
          </p>
  ...
  const RadioGroup = ({ name, value, options, onChange }: { name: string; value: string; options: string[]; onChange: (v: string) => void }) => (
      ...
      <div className="max-w-3xl mx-auto">
        <div className="max-w-2xl mb-10">
          ...
          <p className="text-[15px] leading-[1.65] text-muted">
            Esta información permite que la Dra. Montero llegue a tu primera consulta ya preparada para tu caso. 100% confidencial.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl border border-ink/8 p-7 sm:p-10 flex flex-col gap-7 shadow-sm">
          ...
          <div>
            ...
            <RadioGroup name="procedimiento" value={form.procedimiento}
              options={['Mommy Makeover', 'BBL', 'Rinoplastia', 'Aumento de busto', 'Abdominoplastia', 'Otro']}
              onChange={v => set('procedimiento', v)} />
          </div>

          {/* Q4 — Partos (condicional) */}
          ...
          <div>
            ...
            <RadioGroup name="cirugiasprevias" value={form.cirugiasPrevias} options={['No', 'Sí, una', 'Sí, varias']} onChange={v => set('cirugiasPrevias', v)} />
          </div>

          {/* Q7 — Enfermedad crónica */}
          <div>
            ...
            <RadioGroup name="enfermedad" value={form.enfermedadCronica} options={['No', 'Sí']} onChange={v => set('enfermedadCronica', v)} />
          ...
          <div>
            ...
            <RadioGroup name="fuma" value={form.fuma} options={['No', 'Ocasionalmente', 'Sí, regularmente']} onChange={v => set('fuma', v)} />
          ...
          {/* Q9 — Lactancia/embarazo */}
          <div>
            <label className={labelClass}>9. ¿Estás en período de lactancia o embarazo?</label>
            <RadioGroup name="lactancia" value={form.lactancia} options={['No', 'Embarazada', 'En lactancia']} onChange={v => set('lactancia', v)} />
          </div>

          {/* Q10 — Fotos referencia */}
          <div>
            <label className={labelClass}>10. ¿Tienes fotos de referencia del resultado que buscas?</label>
            <RadioGroup name="fotos" value={form.fotosReferencia} options={['Sí, las tengo', 'Aún no', 'Las buscaré antes']} onChange={v => set('fotosReferencia', v)} />
          </div>

          {/* Q11 — Acompañante */}
          <div>
            <label className={labelClass}>11. ¿Tienes alguien que te acompañe durante la recuperación?</label>
            <RadioGroup name="acompanante" value={form.acompanante} options={['Sí', 'No, necesito apoyo', 'Aún no sé']} onChange={v => set('acompanante', v)} />
          </div>

          {/* Q12 — Viaje */}
          <div>
            <label className={labelClass}>12. ¿Vienes desde fuera de Tijuana o del extranjero?</label>
            <RadioGroup name="viaje" value={form.fueraTijuana} options={['Soy de Tijuana', 'Vengo de otro estado', 'Vengo del extranjero (USA/otro)']} onChange={v => set('fueraTijuana', v)} />
          </div>

          {/* Q13 — Hospedaje/transporte */}
          <div>
          ...
          <div className="pt-4 border-t border-ink/8">
            <button type="submit"
              ...
              Enviar por WhatsApp a la Dra. Montero
            </button>
            <p className="mt-3 text-[12px] text-muted">
              Al enviar, se abre WhatsApp con tu información resumida. Tiempo de respuesta: menos de 30 min.
            </p>
          </div>
        </form>
      </div>
    ...
    <section id="contacto" className="section-pad py-20 bg-white border-t border-ink/8">
      <div className="grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <div className="mt-8 p-5 rounded-2xl border border-ink/8 bg-stone">
            <div className="text-[11px] font-bold uppercase tracking-[0.14em] text-muted mb-2">Dirección</div>
            <div className="text-[14px] font-semibold text-ink leading-[1.7]">
              Erasmo Castellanos q.1874-102<br />
              Zona urbana Río · Tijuana, B.C.
            </div>
            <a href="https://maps.google.com/?q=Tijuana+BC+Mexico" target="_blank" rel="noreferrer"
              className="inline-flex items-center gap-1.5 mt-3 text-[12.5px] font-semibold hover:underline"
              style={{ color: CLINIC }}>
              Ver en Google Maps →
            </a>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <a href="https://wa.me/526649749264" target="_blank" rel="noreferrer"
        ...
        style={{ backgroundColor: '#22C35E', '--pulse-color': '#22C35E55' } as React.CSSProperties}>
