...
export const SPECIALTIES: Specialty[] = [
  {
    ...
    accentSoft: '#FCE3D8',
    code: '01',
    photo: '/photos/dr-michel.jpg',
    es: {
      name: 'Cirugía Plástica',
      tag: 'Estética & Reconstructiva',
      desc: 'Armonía, proporción y resultados naturales. El Dr. Michel diseña cada procedimiento alrededor de tu anatomía — con acompañamiento one-on-one.',
      doctor: 'Dr. Zuriel Michel Barrera',
      doctorRole: 'Cirujano Plástico · CMCPER #2600',
      procedures: ['Lipo HD', 'BBL', 'Mommy Makeover', 'Armonización Facial'],
    },
    en: {
      name: 'Plastic Surgery',
      tag: 'Aesthetic & Reconstructive',
      desc: 'Harmony, proportion and natural results. Dr. Michel designs every procedure around your anatomy — with one-on-one care throughout.',
      doctor: 'Dr. Zuriel Michel Barrera',
      doctorRole: 'Plastic Surgeon · CMCPER #2600',
      procedures: ['HD Lipo', 'BBL', 'Mommy Makeover', 'Facial Contouring'],
    },
  },
  {
    id: 'bariatria',
